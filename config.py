...
VERSION_NOTES = "Версия 0.11.4. Навигация в инвентаре: из карточки вещи кнопка «В категорию» возвращает к списку вещей категории, ниже — «К списку категорий». Ранее: v0.11.3 подземелья — вход с картинкой по времени суток через админ-панель; v0.11.2 здания — 4 картинки на время суток."

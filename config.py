...
VERSION_NOTES = "Версия 0.11.1. Админ-локации: починено редактирование доступа (кнопки «Требуемый статус» и «Блокирующие состояния» больше не мёртвые, блокировки выбираются чекбоксами), режим «Статус и выше»/«Только конкретному» теперь запрашивает статус; новый пункт «Редактировать здание» — название/описание/картинка здания. Ранее: v0.11.0 переезд кадки с растением, архив новостей ГосСМИ 7 дней, блокировка действий во время рыбалки, вход в ГосСМИ по роли; v0.10.4 уведомления и налог на жильё."

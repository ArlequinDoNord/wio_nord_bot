...
VERSION_NOTES = "Версия 0.13.0. Редактор рыбалки: рыбу можно добавить в водоём («➕ Добавить рыбу» — предметы категории рыб с весом 1/1) и убрать из него («🗑 Удалить из водоёма»); исключённую рыбу стартовая синхронизация не возвращает. После любой правки бот сразу возвращает карточку рыбы (вес/фото/цена) или меню водоёма. Ранее: v0.12.1 рыбалка водохранилища по механике озера с админ-редактором, награды с 5 бонусами, позывные пилотов, рецепты жареной рыбы, фикс кадки."

...
VERSION_NOTES = "Версия 0.11.5. Банк переехал в «Город»: теперь это локация с редактируемыми картинками. Туристам банк доступен, но счёт ограничен 200 НМ (переводы сверх лимита блокируются, средства возвращаются). Ранее: v0.11.4 навигация в инвентаре; v0.11.3 подземелья — вход с картинкой по времени суток."

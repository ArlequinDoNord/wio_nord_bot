...
VERSION_NOTES = "Версия 0.13.8. Фикс рыбалки в подземном водохранилище: при поклёвке выбор рыбы не выполнялся (пропущенный await) — улов не записывался, окно зависало, далее шли «устаревшие кнопки». Ранее: v0.13.7 название растения в кадке задаётся в админ-мастере семечка."

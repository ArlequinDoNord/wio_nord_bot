...
VERSION_NOTES = "Версия 0.13.9. Расширено логирование и админ-инструменты разбора: 1) «устаревшие кнопки» и ошибки хендлеров пишутся в лог активности игрока (поиск проблем по имени/тегу); 2) экран «Активность игроков» — общий поток действий всех игроков с фильтрами; 3) ручной ввод @username/имени/ID в «Лог игрока»; 4) автоочистка лога старше 30 дней. Ранее: v0.13.8 фикс рыбалки в подземном водохранилище (пропущенный await)."

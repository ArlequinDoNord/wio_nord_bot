...
VERSION_NOTES = "Версия 0.11.8. Новая локация «Курс Выживания для Пилотов» (К.В.П.): 8 комнат с препятствиями и боссом, лимит 4 прохождения, награда «Значок В.У.С.П.» (+2% урона в подземельях, постоянно) и дроп «Офицерского стека». Ранее: v0.11.7 иконка «Убрать кадку»; v0.11.6 кнопка «Назад» в админ-магазине; v0.11.5 банк в «Город»."

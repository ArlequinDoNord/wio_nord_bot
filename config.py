...
VERSION_NOTES = "Версия 0.13.17. Фиксы по багам: подтверждение покупки (всплывающее «✅ Куплено»), вход в подземелье по контракту, водоросли из улова. Ранее: v0.13.16 кнопка стены из главного меню."

...
VERSION_NOTES = "Версия 0.13.7. Админка: при создании семечка можно сразу указать, как выросшее растение называется в кадке (поле «🌳 Растение в кадке» в мастере и в правке товара) — название хранится в товаре, новые посадки показывают его. Ранее: v0.13.6 в кадке растение зовётся по имени (Яблоня), а не как семечко."

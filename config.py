...
VERSION_NOTES = "Версия 0.11.19. Описание нашивки «Значок В.У.С.П.»: +2% урона и +3% уклонения. Админ-редактор врагов подземелий (HP/АТК/уклонение/яд/дропы) — правки идут без деплоя и не сбрасываются при рестарте. Ранее: v0.11.18 возврат к карточке после продажи; v0.11.17 продажа только лишней экипировки; v0.11.16 покупка в карточке товара."

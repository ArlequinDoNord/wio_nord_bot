...
VERSION_NOTES = "Версия 0.11.0. Переезд: кадка с растением перевозится вместе с растением (рост замораживается в дороге). Архив новостей ГосСМИ в Библиотеке показывает выпуски старше 7 дней. Во время рыбалки (заброс→результат) действия из других меню блокируются. Здание ГосСМИ: вход только журналисту/редактору/админу, у остальных предупреждение; исправлена страница превью с кнопками «Войти»/«В город». Ранее: v0.10.4 уведомления и оплата долга по налогу на жильё; v0.10.3 админ-локации (описание/картинка через бота + логирование) и сюрприз на озере; v0.10.2 dict-строки БД; v0.10.0 рынок с ценой, налог, лимит хила."

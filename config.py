...
VERSION_NOTES = "Версия 0.11.15. Починен фикс: продажа из инвентаря с подтверждением теперь реально работает (в v0.11.14 кнопка «Да, продать» падала). Ранее: v0.11.14 подтверждение и выбор количества при продаже; v0.11.13 «Одежда»; v0.11.12 вкладка «Снаряжение»."

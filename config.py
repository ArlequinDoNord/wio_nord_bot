...
VERSION_NOTES = "Версия 0.11.13. Категория брони в инвентаре переименована из «Снаряжение» в «Одежда», чтобы не путать с вкладкой «Снаряжение» (слоты экипировки). Ранее: v0.11.12 вкладка «Снаряжение»; v0.11.11 уклонение в бою; v0.11.10 допуск по снаряжению в К.В.П.; v0.11.9 фикс кнопки «Атаковать» на Ефрейторе."

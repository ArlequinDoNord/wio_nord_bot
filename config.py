...
VERSION_NOTES = "Версия 0.13.1. Фикс: кнопка «📡 Установить позывной» (и «🗑 Удалить фото пилота») снова видна в админ-панели (can_manage_users в perm_flags). Имя пилота в профиле/карточке теперь показывает @username (или позывной, если нет юзернейма), а не реальное имя из Telegram. Ранее: v0.13.0 редактор рыбалки — добавление/удаление рыбы в водоёмах."

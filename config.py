...
VERSION_NOTES = "Версия 0.11.14. Продажа из инвентаря: теперь с подтверждением и выбором количества («Продать 1» / «Продать всё (N)») — случайно столок не уплывёт. Покупка показывает итоговое количество в инвентаре, а в карточке магазина видно «У тебя уже есть: N шт». Ранее: v0.11.13 «Одежда»; v0.11.12 вкладка «Снаряжение»; v0.11.11 уклонение в бою."

...
VERSION_NOTES = "Починены квартира и кадка: установка расширения больше не падает, кадка переименована в «Кадку для растений». Из квартиры возврат в город. Рыбалка закрыта от старых окон (из магазина удочку не бросить). Духовой шкаф видит улов. В инвентаре — подменю по категориям."

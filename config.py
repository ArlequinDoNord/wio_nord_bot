...
VERSION_NOTES = "Ратуша: в карточке пилота — аватар и просмотр профиля прямо в боте (скрыть профиль может только VIP). История банка: списание/зачисление средств. Жильё: плата за перепланировку (первая установка бесплатна). Фонтан — отдых, а не набор воды. Исправлены alert-ы кухни и дубль состояния в профиле. Новое в админ-панели: «Хранилище» — вернуть распроданные предметы в магазин."

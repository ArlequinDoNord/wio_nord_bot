...
VERSION_NOTES = "Версия 0.13.15. Стена изречений: доска объявлений города — до 40 символов, 4 бесплатных в сутки, далее платные ступени (3×30, 3×90, 3×200 НМ), админ может удалить любое с возвратом ⅓ стоимости автору. Ранее: v0.13.14 контракты от Штаба ВС."

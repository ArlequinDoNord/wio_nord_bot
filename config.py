...
VERSION_NOTES = "Версия 0.13.4. Подземелье: выход — только через подтверждение («Ты уверен?», с показом выносимого лута), а пока идёт рыбалка в водохранилище — выход и продолжение пути заблокированы (сначала дождись улова), повторный заброс больше не плодит гонки. Ранее: v0.13.3 весь улов рыбалки — в «Улов»."

...
VERSION_NOTES = "Версия 0.11.7. Жильё: иконка «Убрать кадку / Убрать из слота» заменена с ножа 🔪 на инструменты 🛠️. Ранее: v0.11.6 кнопка «Назад» в админ-магазине; v0.11.5 банк в «Город», лимит туриста 200 НМ."

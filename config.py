...
VERSION_NOTES = "Версия 0.13.3. Весь улов рыбалки — в «Улов»: и рыба (вес, свежесть, порча), и находки без наживки (сапог/водоросли — без срока годности). У записей водоёма в админке — тип «рыба/ресурс» и переключатель «Рынок»; находки можно «Использовать» (водоросли +1 ОД); рынок улова управляется флагом предмета; покупка улова приходит в «Улов»; легаси-мусор из инвентаря перенесён в «Улов». Ранее: v0.13.2 рынок предметов и менеджер дропов."

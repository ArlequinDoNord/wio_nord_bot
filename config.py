...
VERSION_NOTES = "Версия 0.12.1. Рыбалка в водохранилище — как на озере: удочка, наживка, шанс улова и вес, смена слотов расходников; рыба и веса — в БД с админ-редактором (Подземелья → Рыбалка: веса дня/ночи, фото, цена продажи). Награды: описание, картинка и 5 бонусов (атака/защита/уклонение/рыбалка/HP) с динамическим расчётом в бою. Позывные пилотов: админ ставит, карточка показывает вместо @username. Рецепты жареной рыбы (сом/угорь/форель) с солью и водорослями; соль нельзя «использовать»; рынок: подписи +1/−1 и предупреждение у границ ±30%. Фикс: кадка не теряет растение при переезде. Ранее: v0.12.0 расширение «Крысиного Подвала»."

...
VERSION_NOTES = "Версия 0.11.9. К.В.П.: исправлена кнопка «Атаковать» на Ефрейторе (падение при комнате после препятствия), Ефрейтор теперь встречается чаще, тексты переведены на «ОД», обновлено описание локации и правила. Ранее: v0.11.8 локация «Курс Выживания»; v0.11.7 иконка «Убрать кадку»; v0.11.6 кнопка «Назад» в админ-магазине; v0.11.5 банк в «Город»."

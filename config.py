...
VERSION_NOTES = "Версия 0.13.6. Жильё: растение в кадке теперь называется как само растение (Яблоня), а не как семечко из магазина. Ранее: v0.13.5 картинки стадий кадки."

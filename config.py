...
VERSION_NOTES = "Версия 0.13.2. Рынок обычных предметов: у товаров появился флаг «🏪 можно продавать через рынок» (ставится в мастере товара и в правке), в инвентаре кнопка «На рынок» (цена ±30% от цены скупщика), новая категория «🎪 Рынок» в магазине (предметы и рыба рядом, слоты/лицензия общие). Админ-редактор врагов: менеджер дропов (предмет из игры или новый через полный мастер), правка описания и картинки врага. Ранее: v0.13.1 фикс админ-кнопок и имя пилота = @username."

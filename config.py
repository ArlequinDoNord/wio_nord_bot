...
VERSION_NOTES = "У Ратуши на башенных часах показывается текущее время; кнопка «Наживка» в меню озера снова работает (фикс падения и потери step-guard); в лавке появилась Соль — теперь жареная рыба готовится со специями."

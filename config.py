...
VERSION_NOTES = "Версия 0.13.11. Починены кнопки редактирования наград: 1) callback `aw_ei:<id>:<поле>` распаковывался неверно (ValueError) — «🖼 Картинка» и прочие поля не работали; 2) добавлены недостающие импорты (Inlined keyboard, update_award) — редактор награды снова сохраняет изменения. Ранее: v0.13.10 фиксы расходников в бою и гонки заброса удочки."

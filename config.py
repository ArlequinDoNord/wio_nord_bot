...
VERSION_NOTES = "Версия 0.11.11. Уклонение в бою: у врагов и пилотов появился шанс увернуться от удара. У пилота базово 3% (+3% за нашивку В.У.С.П. — итого 6%). Врагам заданы значения; у Короля крыс теперь 60 HP, у Старшего сержанта атака 5. Ранее: v0.11.10 допуск по снаряжению в К.В.П., «Офицерский стек» убран из продажи; v0.11.9 фикс кнопки «Атаковать» на Ефрейторе."

...
VERSION_NOTES = "Версия 0.11.17. Только лишнюю экипировку можно продать: если предмет надет (или стоит в активном слоте), продаются только свободные экземпляры — надетый остаётся, пока его не снимешь. В карточке — подсказка «продать можно не больше N шт». Ранее: v0.11.16 покупка показывается в карточке товара; v0.11.15 хотфикс продажи."

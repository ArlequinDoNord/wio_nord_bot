...
VERSION_NOTES = "Версия 0.13.13. Оптимизация сервера: из образа убраны неиспользуемые OCR-зависимости (tesseract/pytesseract/Pillow) — образ легче на ~150MB, билды надёжнее; включена ротация логов контейнера. Ранее: v0.13.12 подземелье больше не «залипает»."

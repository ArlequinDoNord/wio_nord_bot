...
VERSION_NOTES = "Профиль: добавлено «О себе» (до 70 символов, кнопка «О себе» в меню профиля). Публичный профиль из Ратуши ограничен — сторонние пилоты видят только фотокарточку, имя и позывной, звание, статус и «О себе»."

...
VERSION_NOTES = "Версия 0.11.12. В инвентаре появилась вкладка «Снаряжение»: броня делится на Голова/Тело/Руки/Ноги, оружие — основное (вспомогательное и слот расходников 3 пока заблокированы). Жмёшь на слот — видишь подходящее из инвентаря, можно надеть/снять; защита складывается со всех слотов брони. Ранее: v0.11.11 уклонение в бою; v0.11.10 допуск по снаряжению в К.В.П.; v0.11.9 фикс кнопки «Атаковать» на Ефрейторе."

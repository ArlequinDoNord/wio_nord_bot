...
VERSION_NOTES = "Версия 0.11.2. Здания: через «Редактировать здание» можно загрузить по 4 картинки на время суток (рассвет/день/закат/ночь) — пикер слотов, отправка фото; игра показывает картинку по текущему времени суток. Ранее: v0.11.1 админ-локации — починен доступ и новое редактирование здания; v0.11.0 переезд кадки с растением, архив новостей ГосСМИ, блокировка действий во время рыбалки, вход в ГосСМИ по роли."

...
VERSION_NOTES = "Напитки: у напитков появился тип действия (выбор в админке при добавлении/правке товара): слабоалкогольный (пиво «Мерцание Севера»: 3 шт/сутки — «пьян», 6 — «очень пьян»), крепкий алкоголь (водка: 1 — «пьян», 2 — «очень пьян»), несварение и/или истощение для безалкогольных. Старое «Бутылка пива» выведено из игры; снятые учебные предметы и T-экипировка удалены полностью. Фонтан в парке получил дневное и ночное фото."

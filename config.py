...
VERSION_NOTES = "Версия 0.13.16. Кнопка «Стена изречений» из главного меню теперь сразу открывает стену, а не просит зайти в город. Ранее: v0.13.15 стена изречений."

...
VERSION_NOTES = "Версия 0.12.0. Расширение «Крысиного Подвала»: 2 этажа (9 комнат + Крысиный капитан, 8 комнат + Король крыс), после капитана выбор «порыбачить в водохранилище» или «продолжить вглубь». Новые враги (Прислужник короля, Чумная крыса, Морозный паук), статусы кровотечение и обморожение (снимают «Огненная вода (водка)» и «Горячий ягодный морс»), рыбалка в водохранилище (Мерцающий сом, Искрящийся угорь, секретная Светящаяся форель). Тексты перед боссами. Ранее: v0.11.19 свапай услуги админ-редактора врагов подземелий."

...
VERSION_NOTES = "Озеро: рядом с вами видно, сколько пилотов сейчас рыбачат (активность за последние 15 минут). Исправлен вход в здание «ГосСМИ» — кнопка публикации выпуска снова видна суперадмину и корреспондентам и при входе из здания."

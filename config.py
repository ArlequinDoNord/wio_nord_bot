...
VERSION_NOTES = "Версия 0.11.6. Админ-магазин: добавлена кнопка «🔙 Назад» в меню «Что изменить?» для товара и в подменю статуса/напитка. Ранее: v0.11.5 банк переехал в «Город», лимит туриста 200 НМ; v0.11.4 навигация в инвентаре."

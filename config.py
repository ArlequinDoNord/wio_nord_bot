...
VERSION_NOTES = "Версия 0.10.2. Стабилизация: строки БД теперь возвращаются как dict — устранён класс ошибок sqlite3.Row .get() по всем хендлерам (кухня, магазин и др.). Перед этим: v0.10.0 рынок с ценой (±30%, слоты, лицензия), налог на жильё, лимит хила в данже; v0.10.1 фикс жарки в кухне."

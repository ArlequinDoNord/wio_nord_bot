...
VERSION_NOTES = "Версия 0.10.4. Налог на жильё: в меню видно, оплачен ли месяц, при долге появляется уведомление и кнопка «Оплатить долг» (гасится вся задолженность разом). Ранее: v0.10.3 админ-локации (описание/картинка через бота + логирование) и сюрприз на озере; v0.10.2 dict-строки БД; v0.10.0 рынок с ценой, налог, лимит хила."

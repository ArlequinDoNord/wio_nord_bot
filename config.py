...
VERSION_NOTES = "Версия 0.11.10. К.В.П.: допуск по снаряжению (оружие — урон до 1, броня — защита до 2), «Офицерский стек» убран из свободной продажи. Ранее: v0.11.9 фикс кнопки «Атаковать» на Ефрейторе; v0.11.8 локация «Курс Выживания»; v0.11.7 иконка «Убрать кадку»; v0.11.6 кнопка «Назад» в админ-магазине."

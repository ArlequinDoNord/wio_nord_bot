...
VERSION_NOTES = "Версия 0.10.3. Админ-локации: описание и картинку здания теперь можно менять через бота (с логированием в админ-логи). Озеро: названия рыб убраны из описания — что поймаешь, останется сюрпризом. Внутреннее: dict-строки БД из v0.10.2; перед этим v0.10.0 рынок с ценой, налог на жильё, лимит хила в данже, v0.10.1 фикс жарки в кухне."

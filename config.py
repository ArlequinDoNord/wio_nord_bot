...
VERSION_NOTES = "Версия 0.13.14. Контракты от Штаба ВС: кнопка подземелья теперь открывает список контрактов, каждый показывает этажи, сложность, награду и стоимость входа — выбор данжа вместо единственного входа. Ранее: v0.13.13 оптимизация сервера."

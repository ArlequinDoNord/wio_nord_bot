...
VERSION_NOTES = "Рынок с назначением цены (±30% от рыночной, 1–3 слота + лицензия на 30 дней); налог на недвижимость (Студия 20 / Квартира 35 / Улучшенное 60 / Особняк 100 НМ/мес); лимит хила в подземелье (6–7 раз → −1/3, 10+ → −1/2)."

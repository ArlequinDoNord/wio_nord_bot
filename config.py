...
VERSION_NOTES = "Версия 0.11.3. Подземелья: вход показывается с картинкой по времени суток, её можно заменить через админ-панель «Подземелья» (4 слота — рассвет/день/закат/ночь, как у зданий). Ранее: v0.11.2 здания — 4 картинки на время суток; v0.11.1 админ-локации — починен доступ и новое редактирование здания; v0.11.0 переезд кадки с растением, архив новостей ГосСМИ, блокировка действий во время рыбалки, вход в ГосСМИ по роли."

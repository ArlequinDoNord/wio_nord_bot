...
VERSION_NOTES = "Магазин: пачки только для расходников и наживки; мебель нельзя купить без свободного слота. Фикс меню наживки в рыбалке. Переводы НМ с сообщением до 40 символов для получателя."

...
VERSION_NOTES = "Версия 0.11.18. После продажи из инвентаря возврат к карточке товара с чеком сверху — можно сразу продать ещё, не заходя в инвентарь заново. Ранее: v0.11.17 продажа только лишней экипировки; v0.11.16 покупка показывается в карточке товара; v0.11.15 хотфикс продажи."
